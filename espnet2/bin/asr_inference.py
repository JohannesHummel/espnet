...
class Speech2Text:
    ...
    def __init__(
        ...
        lm_train_config: Union[Path, str] = "../../../../docker/prebuilt/runtime/test_usage/exp/lm_train_lm_adam_bpe/config.yaml",
        lm_file: Union[Path, str] = "../../../../docker/prebuilt/runtime/test_usage/exp/lm_train_lm_adam_bpe/20epoch.pth",
        token_type: str = None,
        bpemodel: str = None,
        device: str = "cpu",
